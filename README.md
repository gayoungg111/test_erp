...
| 변수명 | 값 | 설명 |
|--------|-----|------|
| `GEMINI_API_KEY` | 발급받은 API Key | [Google AI Studio](https://aistudio.google.com/apikey) |
...
# .env.local 에 GEMINI_API_KEY 설정 후
npx vercel dev
```
...
cp .env.example .env   # GEMINI_API_KEY, GEMINI_MODEL 설정
