...
import { parseUploadedFile, SAMPLE_DATA, validateErpData } from "../services/analyzer";
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          ...
          ERP 거래 데이터를 직접 입력하거나 CSV/Excel 파일을 업로드하세요. 분석은 브라우저에서 처리됩니다.
        ...
        <div className="card">
          ...
          >
            ...
            {validation.valid
              ...
              ? `✅ 검증 성공 — ${validation.data.length}건의 데이터가 유효합니다. (브라우저 분석 완료)`
